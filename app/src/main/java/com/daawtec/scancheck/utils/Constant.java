...
public class Constant {
    ...
    public static String KEY_USER_RECO = "user_reco";
    public static String KEY_USER_AS = "user_as";
    public static String KEY_USER_DPS = "user_dps";
    public static String KEY_USER_SD = "user_sd";
